...
const SCRIPT_URL_CONFIGURED = !SCRIPT_URL.includes('PASTE_YOUR_GOOGLE_APPS_SCRIPT_WEB_APP_URL_HERE')
...
export default function RegisterForm({ tournament }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!SCRIPT_URL_CONFIGURED) {
      ...
      console.warn(
        'SCRIPT_URL is not configured — registrations are not being saved anywhere yet. See the comment above SCRIPT_URL in RegisterForm.jsx.'
      )
      setStatus('success')
      return
    }
